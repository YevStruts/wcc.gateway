...
namespace wcc.gateway.data.Migrations
{
    ...
    [Migration("20240224052918_AddedStatistic")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("wcc.gateway.Infrastructure.Statistic", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("wcc.gateway.Infrastructure.Statistic", b =>
                {
                    b.HasOne("wcc.gateway.Infrastructure.Player", null)
                        .WithOne("Statistic")
                        .HasForeignKey("wcc.gateway.Infrastructure.Statistic", "PlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
