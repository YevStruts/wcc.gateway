...
{
    /// <inheritdoc />
    public partial class AddedTeamsForWC23Main : Migration
    {
        /// <inheritdoc />
...
-- Create touranment
    ...
    VALUES
               ('World Cup 2023', '', 'https://wcc-cossacks.s3.eu-central-1.amazonaws.com/images/wc23-logo.png',
                24, '2023-11-11 00:00:00.0000000', '2023-11-11 00:00:00.0000000', 0, 4);
...
-- Create TouranemntTranslation
    ...
    VALUES (@TournamentId, 1, 'World Cup 2023', '');

    INSERT INTO [dbo].[TournamentTranslations] ([TournamentId],[LanguageId],[Name],[Description])
    VALUES (@TournamentId, 2,N'Кубок Світу 2023', '');
