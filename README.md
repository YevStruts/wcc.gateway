...
# Server
# docker run --name wcc.ui -p 80:80 -p 433:433 -d yevstruts/wcc.ui:2023.3.14.1
...
# docker run --name wcc.gateway -p 80:80 -p 433:433 -d yevstruts/wcc.gateway:2023.3.14.1

# docker run --name wcc.gateway -p 5001:5001 -d yevstruts/wcc.gateway:2023.3.5.2

# -------------------------
# docker tag wcc.gateway.i:latest yevstruts/wcc.gateway:2023.3.14.1
# docker tag wcc.ui.i:latest yevstruts/wcc.ui:2023.3.14.1

# docker push yevstruts/wcc.gateway:2023.3.14.1
# docker push yevstruts/wcc.ui:2023.3.14.1

# docker stop wcc.ui;docker rm wcc.ui;docker stop wcc.gateway;docker rm wcc.gateway;
# docker run --name wcc.ui -p 80:80 -d yevstruts/wcc.ui:2023.3.14.1
# docker run --name wcc.gateway -p 5001:80 -p 5002:433 -d yevstruts/wcc.gateway:2023.3.14.1
