...
# add tag
# docker tag wccgateway_wcc_gateway:latest yevstruts/wcc.gateway:2023.12.18.1
# push
# docker push yevstruts/wcc.gateway:2023.12.18.1

# -p <host_port>:<container_port>

# Server
# docker run --name wcc.ui -p 80:80 -p 433:433 -d yevstruts/wcc.ui:2023.12.18.1
...
# docker run --name wcc.gateway -p 80:80 -p 433:433 -d yevstruts/wcc.gateway:2023.12.18.1
...
# -------------------------
# docker tag wcc.ui.i:latest yevstruts/wcc.ui:2023.12.18.1
# docker tag wcc.gateway.i:latest yevstruts/wcc.gateway:2023.12.18.1
# docker tag wcc.rating.i:latest yevstruts/wcc.rating:2023.12.18.1
# docker tag wcc.lanserver.i:latest yevstruts/wcc.lanserver:2023.12.18.1

# docker push yevstruts/wcc.gateway:2023.12.18.1
# docker push yevstruts/wcc.ui:2023.12.18.1
# docker push yevstruts/wcc.rating:2023.12.18.1
# docker push yevstruts/wcc.lanserver:2023.12.18.1
...
# docker run --name wcc.ui -p 3000:80 -d yevstruts/wcc.ui:2023.12.18.1
# docker run --name wcc.gateway -p 3001:80 -p 5002:433 -d yevstruts/wcc.gateway:2023.12.18.1
# docker run --name wcc.rating -p 6001:80 -p 6002:433 -d yevstruts/wcc.rating:2023.12.18.1
# docker run --name wcc.lanserver -p 31523:31523 -d yevstruts/wcc.lanserver:2023.12.18.1
...
# dotnet cake --target=PushAll --version=2023.12.18.1